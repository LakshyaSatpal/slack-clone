  ...
  return (
    <div>
      <ActionTooltip side="right" label="Create new" align="center">
        ...
        >
          <div className="flex mx-3 h-[48px] w-[48px] rounded-[24px] transition-all overflow-hidden items-center justify-center bg-[#815286] dark:bg-[#5B3C5E] group-hover:scale-105">
